...
const SHELL = "skyline-shell-v1";
const DATA = "skyline-data-v1";
...
self.addEventListener("fetch", e => {
  ...
  else if (url.hostname.endsWith("fonts.googleapis.com") || url.hostname.endsWith("fonts.gstatic.com")) e.respondWith(cacheFirst(e.request, SHELL));
